...
const components = {
    mail: appInput({ value: '', placeholder: 'Email', type: 'email', id: 'email'}),
    login: appInput({ value: '', placeholder: 'Login', type: 'text', id: 'login'}),
    firstName: appInput({ value: '', placeholder: 'First Name', type: 'text', id: 'first-name'}),
    lastName: appInput({ value: '', placeholder: 'Last Name', type: 'text', id: 'last-name'}),
    phone: appInput({ value: '', placeholder: 'Phone', type: 'text', id: 'phone'}),
    pass: appInput({ value: '', placeholder: 'Password', type: 'password', id: 'pass'}),
    passAgain: appInput({ value: '', placeholder: 'Password (again)', type: 'password', id: 'pass-again'}),
    createBtn: appButton({ buttonText: 'Create account' }),
    loginLink: appLink({ to: '/login', linkText: 'Sign in' })
}
